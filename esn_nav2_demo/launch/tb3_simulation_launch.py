...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('esn_nav2_demo')
    ...
    ld = additional_launch(ld)

    return ld


def additional_launch(ld: LaunchDescription) -> LaunchDescription:

    local_costmap_voxel_converter = Node(
    ...
    ld.add_action(local_costmap_voxel_converter)
